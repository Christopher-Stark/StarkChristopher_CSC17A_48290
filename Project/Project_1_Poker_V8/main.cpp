...
int main(int argc, char** argv)
{
    ...
    //binGetRecords(binFile, player); **Not needed
...
void binRecordUpdate(string fileName, Player *a)
{
    ...
    fileOut.open(fileName, ios::out | ios::binary);
    string name;
    int crdWon, crdLst, hndWon, hndLst;
    

    for(int i = 0; i < a->crdData.rcdSize; i++)
    {
    fileOut.write(reinterpret_cast<char*> (&a->record[i]), sizeof (a->record));
    }
